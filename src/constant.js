...
export const footer = {
    PrinTek: "PrinTek pvt. ltd.",
    aboutPrinTek: "We are one of the largest printing companies in the Okhla Industrial Area, providing our services across India for many years.",
    aboutAndServicesHeader: "What we can build for you",
    contact: "+91 99999, 011 111111",
    email: "info@PrinTek.in, info.PrinTek@gmail.com",
...
export const WhoWeAreConstants = {
    ...
    OurStoryDetail: "PrinTek started its journey in 1992, we combines decades of expertise and a commitment to excellence in print production.\n Founded by Arjun, a visionary entrepreneur with a degree in Printing Technology, our journey began in Delhi, where we have since evolved into a leading print production house in northern India.\n Our comprehensive in-house operation ensures meticulous control over quality and rapid turnaround times.\n We strive not only to meet but exceed customer expectations consistently, aiming to be the preferred partner for all print needs.\n At PrinTek, we believe in creating value by fully understanding our customers' requirements, collaborating closely, and optimizing print project specifications—from size to paper selection-to deliver cost-effective, top-tier products.",
    ...
    deliveryAwardContent: "In the fiscal year 1999-2000, PrinTek was honored to receive its very first prestigious accolade, the Delivery Award, from none other than Sony. This distinguished award was presented to PrinTek in recognition of our exceptional service and dedication as Sony’s inaugural high-profile client. The Delivery Award marked a significant milestone in our company’s history, celebrating our successful collaboration with Sony and acknowledging our commitment to excellence in the printing industry. This achievement not only highlighted the strength of our partnership but also set a precedent for future endeavors, reinforcing our role as a trusted and reliable service provider in the industry.",
    certificationOfHonour: "Certification of Honour",
    certificationOfHonourContent: "PrinTek is proud to announce that we have received a prestigious Certification of Honour from the Ministry of Micro, Small & Medium Enterprises (MSME). This recognition highlights our unwavering commitment to excellence, innovation, and quality in the print production industry. ",
    economicSurveyOfIndia: "Economic Survey of India",
    economicSurveyOfIndiaContent: "The PrinTek printed Economic Surveys for 2015-16, 2016-17, and 2018-19 offer a detailed examination of India’s economic landscape over these years. The 2015-16 survey highlights key growth trends and structural reforms, while the 2016-17 survey focuses on the implications of GST and fiscal policies. The 2018-19 survey reviews economic challenges including inflation and investment dynamics. These publications are essential for understanding India's economic strategies and outcomes during these crucial periods.",
    indianConstitutionOfIndia: "Indian constitution of India",
    indianConstitutionOfIndiaContent: "PrinTek is proud to have printed the Constitution of India in the years 2014, 2018, and 2022. This prestigious task highlights our dedication to precision and excellence in print production. Each edition required meticulous attention to detail, ensuring the highest quality standards. Printing the Constitution is a matter of national pride and a testament to our expertise. We are honored to contribute to the preservation and dissemination of this foundational document. PrinTek remains committed to upholding this legacy of excellence.",
    enterpreneurOfTheYear: "Entrepreneur Of the year",
    enterpreneurOfTheYearContent: "PrinTek, the founder of PrinTek, was honored with the MERI College Excellence Award for Entrepreneur of the Year in 2018. This prestigious recognition celebrates his exceptional leadership and innovative contributions to the print production industry. Under his visionary guidance, PrinTek has grown into a leading print production house, known for its commitment to quality and excellence. The award underscores Arjun's entrepreneurial spirit and dedication to advancing the industry. PrinTek takes immense pride in his achievements and looks forward to continued success under his leadership."
}
